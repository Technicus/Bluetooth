...
public class BluetoothHandlerSPP{
   ...
   public BluetoothHandlerSPP(Context context, BluetoothHandler handler) {
   ...
   private synchronized void setState(State state) {
      ...
      mHandler.obtainMessage(BluetoothHandler.MessageType.STATE, -1, state)
          .sendToTarget();
   }
   ...
   private synchronized void connected(BluetoothSocket socket,
      ...
      mHandler.obtainMessage(BluetoothHandler.MessageType.DEVICE, -1,
   ...
   private void sendErrorMessage(int messageId) {
      setState(State.LISTEN);
      mHandler.obtainMessage(BluetoothHandler.MessageType.NOTIFY, -1,
   ...
   private class AcceptThread extends Thread {
      ...
      public void run() {
         ...
         while (mState != BluetoothHandlerSPP.State.CONNECTED) {
            try {
            ...
            if (socket != null) {
               synchronized (BluetoothHandlerSPP.this) {
                  switch (mState) {
                     case LISTEN:
                     case CONNECTING:
   ...
   private class ConnectThread extends Thread {
      ...
      public void run() {
         ...
         try {
            ...
            BluetoothHandlerSPP.this.start();
            return;
         }
   ...
   private class ConnectedThread extends Thread {
      ...
      public void write(byte[] buffer) {
         try {
            ...
            mHandler.obtainMessage(BluetoothHandler.MessageType.WRITE, -1,
                buffer).sendToTarget();
         } catch (IOException e) {
